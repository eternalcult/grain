...
final class DataStorage {
    ...
    private(set) var filtersCategories: [FilterCategory] = [
        ...
        .init(title: "Cinema", desc: "", filters: [
            ...
            .init(id: 49, title: "Matrix V1", desc: "'There is no spoon.'", filename: "Matrix V1"),
            .init(id: 50, title: "Matrix V2", desc: "'I know kung fu.'", filename: "Matrix V2"),
        ...
        .init(title: "Cinema", desc: "", filters: [
            .init(id: 161, title: "Psycho", desc: "'We all go a little mad sometimes.'", filename: "CINECOLOR_PSYCHO"),
            .init(id: 221, title: "Alien", desc: "'In space, no one can hear you scream.'", filename: "CINECOLOR_ALIEN"),
            .init(id: 171, title: "Blade Runner 2049", desc: "'You’ve never seen a miracle.'", filename: "CINECOLOR_BLADE_RUNNER_2049"),
            .init(id: 181, title: "Clockwork Orange", desc: "'What’s it going to be then, eh?'", filename: "CINECOLOR_CLOCKWORK_ORANGE"),
            .init(id: 191, title: "Jaws", desc: "'You’re gonna need a bigger boat.'", filename: "CINECOLOR_JAWS"),
            .init(id: 201, title: "Saving Private Ryan", desc: "'Earn this.'", filename: "CINECOLOR_SAVING_PRIVATE_RYAN"),
            .init(id: 211, title: "Sin Sity", desc: "'The night is hot as hell.'", filename: "CINECOLOR_SIN_CITY"),
            .init(id: 271, title: "Amelie", desc: "'Times are hard for dreamers.'", filename: "Amelie"),
            .init(id: 281, title: "Aviator", desc: "'The way of the future.'", filename: "Aviator"),
            .init(id: 291, title: "Blade Runner", desc: "'All those moments will be lost in time… like tears in rain.'", filename: "Blade Runner"),
            .init(id: 351, title: "Drive", desc: "'You give me a time and a place, I give you a five-minute window.'", filename: "Drive"),
            .init(id: 421, title: "Godfather", desc: "'I'm gonna make him an offer he can't refuse.'", filename: "Godfather"),
            .init(id: 431, title: "Grand Budapest", desc: "'Rudeness is merely the expression of fear.'", filename: "Grand Budapest"),
            .init(id: 461, title: "Hannibal", desc: "'I’m having an old friend for dinner.'", filename: "Hannibal"),
            .init(id: 471, title: "Her", desc: "'The past is just a story we tell ourselves.'", filename: "Her"),
            .init(id: 481, title: "Mad Max", desc: "'Oh, what a day! What a lovely day!'", filename: "Mad Max"),
            .init(id: 491, title: "The Matrix", desc: "'There is no spoon.'", filename: "Matrix V1"),
            .init(id: 501, title: "The Matrix Reloaded", desc: "'I know kung fu.'", filename: "Matrix V2"),
            .init(id: 521, title: "Moonrise Kingdom", desc: "'I love you, but you don’t know what you’re talking about.'", filename: "Moonrise Kingdom"),
            .init(id: 591, title: "Stranger Things", desc: "'Friends don’t lie.'", filename: "Stranger Things"),
            .init(id: 641, title: "Wonder Woman", desc: "'It’s about what you believe.'", filename: "Wonder Woman"),
            .init(id: 551, title: "Revenant", desc: "'As long as you can still grab a breath, you fight.'", filename: "Revenant"),
            .init(id: 381, title: "Enemy", desc: "'Chaos is order yet undeciphered.'", filename: "Enemy"),
            .init(id: 571, title: "Seven", desc: "'What’s in the box?!'", filename: "Seven"),
        ])
    ]
}
